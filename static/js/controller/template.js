...
export let UrlGetBiodataSekolahWithToken = 'https://komarbe.ulbi.ac.id/biodata/data_sekolah/get/token';
export let UrlGetKuesionerWithToken = "https://komarbe.ulbi.ac.id/kuesioner/get";
...
export const TokenHeader = "LOGIN";
