...
const inputFile2 = document.getElementById('suratundangan_input');
inputFile2.addEventListener('change', () => {
  console.log("onchange jalan nih");
    postFileWithHeader(UrlFileServicePost, "login", token, "suratundangan_input", "image", inputRender);
});
const inputFile3 = document.getElementById('rapor_input');
inputFile3.addEventListener('change', () => {
  console.log("onchange jalan nih");
    postFileWithHeader(UrlFileServicePost, "login", token, "rapor_input", "image", inputRender);
});
